 ...
 */
template <typename... T> void print(FILE *f, text_style ts, format_string<T...> fmt, T &&...args)
{
 ...
 *                "Elapsed time: {0:.2f} seconds", 1.23);
 */
template <typename... T> void print(text_style ts, format_string<T...> fmt, T &&...args)
{
  return print(stdout, ts, fmt, std::forward<T>(args)...);
}

inline void vprintln(FILE *f, text_style ts, string_view fmt, format_args args)
{
  auto buf = memory_buffer();
  detail::vformat_to(buf, ts, fmt, args);
  buf.push_back('\n');
 ...
 *                  "Elapsed time: {0:.2f} seconds", 1.23);
 */
template <typename... T> void println(FILE *f, text_style ts, format_string<T...> fmt, T &&...args)
{
 ...
 *                  "Elapsed time: {0:.2f} seconds", 1.23);
 */
template <typename... T> void println(text_style ts, format_string<T...> fmt, T &&...args)
{
 ...
 * ```
 */
template <typename... T> inline auto format(text_style ts, format_string<T...> fmt, T &&...args) -> std::string
{
...
template <typename T, typename Char> struct formatter<detail::styled_arg<T>, Char> : formatter<T, Char>
{
  ...
  FMT_CONSTEXPR auto format(const detail::styled_arg<T> &arg, FormatContext &ctx) const -> decltype(ctx.out())
  {
